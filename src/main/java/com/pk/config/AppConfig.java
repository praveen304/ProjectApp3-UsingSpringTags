...
public class AppConfig implements WebMvcConfigurer{
	...
	public LocalSessionFactoryBean sf() {
		...
		s.setPackagesToScan("com.pk.model");
		return  s;
	}
	public Properties props() {
		...
		p.put("hibernate.format_sql",env.getProperty("orm.format_sql"));
		p.put("hibernate.hbm2ddl.auto",env.getProperty("orm.htm2ddl.auto"));
		return p;
		}
	...
	//6.active CommonsMultipartResolver
	@Bean
