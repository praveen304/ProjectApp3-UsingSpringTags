...
public class OrderMethodTypeUtil {
	...
	public void generatePie(String path, List<Object[]> data) {
		...
		JFreeChart chart=ChartFactory.createPieChart3D("OrderMethodTypeModes", dataset, true, true, false);
		//3. save as Image using ChartUtils
		try {
		ChartUtils.saveChartAsJPEG(new File(path+"/resources/images/orderedPie.jpg"), chart, 400, 400);
		} 
		catch (IOException e) {
		e.printStackTrace();
		}
	...
	public void generateBar(String path, List<Object[]> data) {
		...
		// 2. Create JFreeChart using ChartFactory
		JFreeChart chart = ChartFactory.createBarChart("OrderMethodTypeMode", "Modes", "COUNT", dataset);
